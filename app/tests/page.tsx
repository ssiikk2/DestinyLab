...
export const metadata: Metadata = buildMetadata({
  title: "All Compatibility Tests and Relationship Calculators",
  description:
    "Choose from calculator, destiny, name, zodiac, crush, birthday, initials, and couple test pages.",
  path: "/tests",
});
    ...
    <section className="mx-auto max-w-5xl space-y-6 px-4 py-8">
      <header className="rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-slate-50 to-blue-50 p-6 shadow-[0_14px_34px_rgba(15,23,42,0.08)]">
        ...
        <p className="mt-2 text-sm text-slate-700 md:text-base">
          Pick a route and run the tool that matches your immediate relationship question.
        </p>
      </header>
